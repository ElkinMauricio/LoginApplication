...
public class ValidarRegistro {
    ...
    public String verificarRegistro(Usuario usuario, String validarContraseña) {
        ...
        if (!PasswordC(usuario.getPassword(), validarContraseña)) {
    ...
    public boolean PasswordC(String contraseña, String validarContraseña) {
        return contraseña.equals(validarContraseña);
    }
}
